    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                ...
                if (document.documentElement.classList.contains("_sub-menu-open")) document.documentElement.classList.toggle("_sub-menu-open");
            }));
        }
        function menuClose() {
            bodyUnlock();
        ...
        function rangeInit() {
            ...
            if (rangeItems.length) rangeItems.forEach((rangeItem => {
                ...
                const setRangeSlider = (i, value) => {
                    ...
                    rangeArray[i] = value;
                    item.noUiSlider.set(rangeArray);
                };
        ...
        if (menuBlocks.length) menuBlocks.forEach((menuBlock => {
            ...
            menuBlock.classList.toggle(`sub-menu-catalog__block_${menuBlockItems}`);
        }));
        ...
        function handleButtonClick(event) {
            event.preventDefault();
            let countClickButton = cartCount.textContent;
            cartCount.textContent = parseInt(countClickButton) + 1;
        }
